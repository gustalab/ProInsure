...
Dosya_No <- destek_excel$Dosya_No  
...
hesap_tarihi_yil <- as.numeric(lubridate::year(Hesap_Tarihi))
  ...
  Ad_Soyad <- destek_excel$Ad_Soyad
  Cinsiyet <- destek_excel$Cinsiyet                         
  Dogum_Tarihi <- as.Date(destek_excel$Dogum_Tarihi)
  Gelir_Durumu <- "Bekar"
  # Gelir_Durumu <- "Gelir"                               # Bekar", "evli_cocuksuz", "1cocuk" ,"2cocuk", "3cocuk", "4cocuk", "Gelir"
  Kaza_Tarihi <- as.Date(destek_excel$Kaza_Tarihi)
...
Es <- destek_excel$Es
Es_Ad <- destek_excel$EsAd 
Es_Dogum_T. <- as.Date(destek_excel$EsDT)      
# 

Cocuk_durumu <- destek_excel$Cocuksay
# 
Cocuk1_Ad <- destek_excel$Cocuk1_Ad
Cocuk1_Dogum_T. <- destek_excel$Cocuk1_DT
Cocuk2_Ad <- destek_excel$Cocuk2_Ad
Cocuk2_Dogum_T. <- as.Date(destek_excel$Cocuk2_DT)
Cocuk3_Ad <- destek_excel$Cocuk3_Ad
Cocuk3_Dogum_T. <- as.Date(destek_excel$Cocuk3_DT)
Cocuk4_Ad <- destek_excel$Cocuk4_Ad
Cocuk4_Dogum_T. <- as.Date(destek_excel$Cocuk4_DT)
Cocuk5_Ad <- destek_excel$Cocuk5_Ad
Cocuk5_Dogum_T. <- as.Date(destek_excel$Cocuk5_DT)
# 
Anne <- destek_excel$Anne
Anne_Ad <- destek_excel$AnneAd
Anne_Dogum_T. <- as.Date(destek_excel$AnneDT) 
# 
Baba <- destek_excel$Baba
Baba_Ad <- destek_excel$BabaAd
Baba_Dogum_T. <- as.Date(destek_excel$BabaDT)
...
Kusur_Orani <- destek_excel$Kusur_Oranı              
...
Kismi_Odeme_Sayisi <- destek_excel$Kısmi_Odeme_Sayısı
