...
```{r echo=FALSE, include=FALSE}
  ...
  Kısmi_Odeme_Tutarı_2 <- params$PKismi_Odeme_Tutarı_2
...
str_glue("Bilinen Dönem Maluliyet Tazminatı toplamı {sirket_odeme_tarihi_bilinen_donem_toplam_tazminat} TL olarak hesaplanmıştır.")
