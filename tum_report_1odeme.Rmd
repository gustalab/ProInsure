...
Sirket_Odeme_Tablosuu <- Sirket_Odeme_Tablosu %>% 
  filter(`Ödenen Tutar` != 0)
  
if (Kısmi_Odeme_Sayısı >= 1) {
  knitr::kable(Sirket_Odeme_Tablosuu, caption = "Şirket Ödeme Tablosu") } else {str_glue("Dosya kapsamında şirket ödemesi görülmemiştir.")}
