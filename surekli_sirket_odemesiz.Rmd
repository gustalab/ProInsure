...
```{r echo=FALSE, include=FALSE}
  ...
  # Kazanilan_Ay1111 = round(as.numeric(difftime(as.Date("2020-12-31"), as.Date("2020-02-05"), units = "days")) / 30, 2)
  
  # Kazanilan_Ay222 = signif(as.numeric(time_length(as.Date("2024-09-09") - as.Date("2024-01-01"), "day")/30) , digits = 2)
  # 
  # Kazanilan_Ay223 = case_when(
  #     Kazanilan_Ay222 >= 11.96 ~ round(Kazanilan_Ay222, digits = 1),
  #     Kazanilan_Ay222 > 6 ~ round(Kazanilan_Ay222, digits = 1),
  #     Kazanilan_Ay222 >= 5.9 ~ round(Kazanilan_Ay222, digits = 1),
  #     Kazanilan_Ay222 >= 4.6 ~ plyr::round_any(Kazanilan_Ay222, 0.1, f = ceiling),
  #     Kazanilan_Ay222 <= 2 ~ plyr::round_any(Kazanilan_Ay222, 0.1, f = ceiling),
  #     TRUE ~ Kazanilan_Ay222)
  # 
  # Kazanilan_Ay223
...
Dosya kapsamında gelir parametresine ilişkin yapılan incelemede, malulün gelir bilgisine ilişkin güncel bir belge görülmediğinden dolayı hesaplamada asgari ücret kullanılmıştır.
...
# 
# 
# str_glue("Bilinmeyen Dönemde Geçici İş Göremezlik Tazminatı {gecici_donem_tazminat} TL olarak hesaplanmıştır.")
...
str_glue("Bilirkişiliğimize iletilen dosya kapsamında yapılan inceleme neticesinde elde edilen hesaplama parametreleri kapsamında gerçekleşen kazada malul kalan {Ad_Soyad} için hesaplanan sürekli maluliyet tazminatı bilirkişi hesap tarihi itibariyle aşağıda belirtilmiştir;")
...
bakiye_tazminat_son <- formattable::currency(bakiye_tazminat, digits = 2, format = "f", big.mark = ".",decimal.mark = ",",  symbol = "") 

str_glue("* Nihai olarak hesaplanan Toplam Bakiye Sürekli Maluliyet Tazminat tutarı {bakiye_tazminat_son} TL olarak hesaplanmıştır.")
