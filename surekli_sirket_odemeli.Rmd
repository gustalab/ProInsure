...
toplam_faiz2 <- scales::percent(toplam_faiz, accuracy = 0.0001)
  
if (Kısmi_Odeme_Sayısı >=1) {
  str_glue("Şirket ödeme tarihinden bilirkişi hesap tarihine kadar geçen süre içinn toplam {toplam_faiz2} faiz hesaplanmıştır. Şirket tarafından yapılan ödemenin bilirkişi hesap tarihli değeri {toplam_kismi_odeme} TL olarak hesaplanmıştır.") } else {str_glue(" ")}
